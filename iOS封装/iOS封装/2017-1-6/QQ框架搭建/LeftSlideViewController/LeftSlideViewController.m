...
static LeftSlideViewController *shareSingleton;

+( instancetype ) sharedLeftSlideVcWithLeftView:(UIViewController *)leftVc
                                    andMainView:(UIViewController *)mainVc  {
    static  dispatch_once_t  onceToken;
    dispatch_once ( &onceToken, ^ {
        shareSingleton = [[ LeftSlideViewController alloc ] initWithLeftView:leftVc andMainView:mainVc ] ;
    } );
